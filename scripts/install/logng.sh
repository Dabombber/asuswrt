...
var FacilityIndex=['kern','user','mail','daemon','auth','syslog','lpr','news','uucp','cron','authpriv','ftp','ntp','security','console','solaris-cron','local0','local1','local2','local3','local4','local5','local6','local7'];var FacilityMap={'kern':0,'user':1,'mail':2,'daemon':3,'auth':4,'syslog':5,'lpr':6,'news':7,'uucp':8,'cron':9,'authpriv':10,'ftp':11,'ntp':12,'security':13,'console':14,'solaris-cron':15,'local0':16,'local1':17,'local2':18,'local3':19,'local4':20,'local5':21,'local6':22,'local7':23,'logaudit':13,'logalert':14,'clock':15};var SeverityIndex=['emerg','alert','crit','err','warning','notice','info','debug'];var SeverityMap={'emerg':0,'alert':1,'crit':2,'err':3,'warning':4,'notice':5,'info':6,'debug':7,'panic':0,'error':3,'warn':4};var BSDDateMap={'Jan':0,'Feb':1,'Mar':2,'Apr':3,'May':4,'Jun':5,'Jul':6,'Aug':7,'Sep':8,'Oct':9,'Nov':10,'Dec':11};var LoggyParser=function(){};LoggyParser.prototype.parse=function(rawMessage,callback){if(typeof rawMessage!='string'){return rawMessage}
